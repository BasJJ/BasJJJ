...
public interface IDialogService
{
    ...
    /// The type of the dialog view model, which should be <see cref="DialogViewModel{TDialogResultType}"/>.
    /// </typeparam>
    ...
    /// <param name="viewModelFactory">A factory function to create instances of the view model. This enables support for injecting services with your approach. Initial is passed but should be nullable</param>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="viewModelFactory"/> is null.</exception>
    void RegisterDialog<TDialogViewModel, TDialogWindow, TDialogResultType>(Func<TDialogResultType?, TDialogViewModel> viewModelFactory)
